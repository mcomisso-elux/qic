...
layout = [
    [sg.Text('Target IP address:'), sg.InputText('10.5.2.173', size = (20, 1)), sg.Text('SNMP community:'), sg.InputText('d3novpLu2yfxeEor@172.22.16.106', size = (20, 1)), sg.Checkbox('Get status'), sg.Checkbox('Get description'), sg.Button('Scan'), sg.Text('Hostname: '), sg.Text(key = "-HOSTNAME-"), sg.Text(text_color = "red", key = "-ACTION-")],
    # [sg.Text('Target IP address:'), sg.InputText('10.5.2.173', size = (20, 1)), sg.Text('SNMP community:'), sg.InputText('d3novpLu2yfxeEor@172.22.16.1', size = (20, 1)), sg.Checkbox('Get status'), sg.Checkbox('Get description'), sg.Button('Scan'), sg.Text('Hostname: '), sg.Text(key = "-HOSTNAME-"), sg.Text(text_color = "red", key = "-ACTION-")],
    ...
    if event == sg.WIN_CLOSED: # If the user closes the window
        ...
        if host != '' and community != '':
            try:
                ...
                # print(f"There are {interfaceCount} interfaces")
